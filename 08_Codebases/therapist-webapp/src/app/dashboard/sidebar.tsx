...
const navKeys = [
  ...
  { key: "availability" as const, href: "/dashboard/availability", icon: Clock },
  { key: "earnings" as const, href: "/dashboard/earnings", icon: TrendingUp },
  { key: "reviews" as const, href: "/dashboard/reviews", icon: Star },
