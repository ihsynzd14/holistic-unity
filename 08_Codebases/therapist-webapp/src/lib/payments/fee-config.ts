...
export function calculatePaymentAmounts(
  ...
  // MUST match the Edge Function `create-booking-with-payment`
  // (docs/flows/07-payment.md):
  //   processingFee = round(price * percent + fixed)
  //   totalCharged  = price + processingFee
  // The previous multiplicative gross-up with Math.ceil drifted from
  // the actual charge by 1-9¢ on non-round prices.
