...
If a single named author is added in the future, update AGENTS.md and the editorial note pattern accordingly.
...
No git workflow defined in this folder yet. If Codex initializes git, suggest:
